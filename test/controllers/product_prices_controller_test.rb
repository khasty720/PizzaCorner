...
class ProductPricesControllerTest < ActionController::TestCase
  ...
  test "should create product_price" do
    assert_difference('ProductPrice.count') do
      post :create, product_price: { active: @product_price.active, price: @product_price.price, product_id: @product_price.product_id, user_id: @product_price.user_id }
    end
  ...
  test "should update product_price" do
    patch :update, id: @product_price, product_price: { active: @product_price.active, price: @product_price.price, product_id: @product_price.product_id, user_id: @product_price.user_id }
    assert_redirected_to product_price_path(assigns(:product_price))
  end
